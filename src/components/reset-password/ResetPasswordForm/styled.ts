...
export const ResetPasswordFormInput = styled(Input)`
  width: 278px;
  height: 40px;
  padding: 10px;
  border-radius: 8px;
...
export const ResetPasswordFormButton = styled(Button).attrs(
...
export const ResetPasswordFormText = styled(Typography.Paragraph).attrs(
  (props: ThemedStyledProps<Props, DefaultTheme>) => ({
